...
/**
 * Class to map to firebase collections and documents
 */
public class Api {
    // collections
    ...
    public static final String USERNAMES_COLLECTION = "usernames";
    ...
    // document fields
    public static final String TASKS_FIELD_NAME = "tasks";
